...
public class SpellManager_old : MonoBehaviour
{
    SpellSpawner_old spawnScript;

    [Header("Scriptable Objects")]
    [SerializeField] private SO_SpellUpgrades_old data_Upgrades;
    [SerializeField] private SO_Spells_old data_AllDirections;
    [SerializeField] private SO_Spells_old data_NearPlayer;
    [SerializeField] private SO_Spells_old data_BaseArcher;
    ...
    {
        spawnScript = FindObjectOfType<SpellSpawner_old>();
